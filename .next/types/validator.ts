...
// Validate ../../app/api/telegram/sync/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/telegram/sync">> = Specific
  const handler = {} as typeof import("../../app/api/telegram/sync/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
