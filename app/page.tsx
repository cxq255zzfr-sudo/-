        ...
        <div className="container footer-inner">
          <div className="footer-social-box">
            ...
            <div className="social-links social-links--footer">
              <a href="http://telegram.me/ALMHARAR" target="_blank" rel="noreferrer" aria-label="تليجرام">
              ...
              <a href="https://www.facebook.com/networkmoharar" target="_blank" rel="noreferrer" aria-label="فيسبوك">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://twitter.com/networkmoharar" target="_blank" rel="noreferrer" aria-label="إكس">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://youtube.com/channel/UCFm-Fy_6kb9F-al0F53LjHQ" target="_blank" rel="noreferrer" aria-label="يوتيوب">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://whatsapp.com/channel/0029Va9oCqMBadmbK22OTv3F" target="_blank" rel="noreferrer" aria-label="واتساب">
                <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <p>©️ 2026 شبكة أخبار سوريا الحرة. جميع الحقوق محفوظة.</p>
        </div>
      </footer>
    </>
  );
